...
class NodeTreeForm(QtGui.QWidget):

	#region Constructor

	def __init__(self):
		"""
		Initializes a new instance of the NodeTreeForm class.
		"""
	...
	def initUI(self):
		...
		self.setWindowTitle("Nodes Selector")
	...
	def __drawNode(self, node):
		...
		brush = QtGui.QBrush()
		if node == Global.nodeTreeForm.selectedNode:
