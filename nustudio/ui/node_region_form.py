...
class RegionForm(QtGui.QDialog):
	...
	def __init__(self):
		"""
		Initializes a new instance of the RegionForm class.
		"""
	...
	def initUI(self):
		...
		# dimensionsLayout
		dimensionsLayout = QtGui.QGridLayout()
		dimensionsLayout.addWidget(self.labelWidth, 0, 0)
		dimensionsLayout.addWidget(self.spinnerWidth, 0, 1)
		dimensionsLayout.addWidget(self.labelHeight, 1, 0)
		dimensionsLayout.addWidget(self.spinnerHeight, 1, 1)
	...
	def setControlsValues(self):
		...
		node = Global.nodeTreeForm.underMouseNode
